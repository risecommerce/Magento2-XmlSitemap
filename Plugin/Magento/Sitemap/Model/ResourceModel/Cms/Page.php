...
namespace Risecommerce\XmlSitemap\Plugin\Magento\Sitemap\Model\ResourceModel\Cms;
...
class Page
{
    ...
    public function afterGetCollection(Subject $subject,array $result): array {
        if($result && $this->config->isEnabled()) {
            ...
            $searchCriteria = $this->searchCriteriaBuilder->addFilter('rc_exclude_xml_sitemap', 1, 'eq')->create();
